...
Public Class Expert
    ...
    Private Sub Loaded(sender As Object, e As EventArgs) Handles Me.Load
        ...
        RobustName.Text = My.Settings.RobustEnabled
        ...
        Robustgrid.Checked = My.Settings.RobustEnabled
    ...
    Private Sub StatsButton_Click(sender As Object, e As EventArgs) Handles WebStats.CheckedChanged
    ...
    Private Sub StandaloneButton_CheckedChanged(sender As Object, e As EventArgs) Handles StandaloneButton.CheckedChanged
        If StandaloneButton.Checked = True Then
            Robustgrid.Checked = False
        End If
    End Sub
    Private Sub Fullgrid_CheckedChanged(sender As Object, e As EventArgs) Handles Robustgrid.CheckedChanged
        If Robustgrid.Checked = True Then
